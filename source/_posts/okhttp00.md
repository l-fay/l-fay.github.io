---
title: 使用OKhttp进行NTLM鉴权
date: 2023-03-30 18:20:26
tags:  [OKhttp, NTLM, Java]
categories:
  - [Java, OKhttp]
  - [权限控制, NTLM]
---

找到了一个用OKhttp进行NTML鉴权的方法。

<!-- more -->

来自[Stack Overflow](https://stackoverflow.com/questions/35620415/how-create-ntlm-authentification-with-retrofit)。

总结一下只需要在项目中增加两个文件。

注意，package不能变，我的理解是这相当于给OKhttp打补丁。

可以在项目中建一个与java同级的文件夹patch，这样不影响原有结构，也不会报错。
